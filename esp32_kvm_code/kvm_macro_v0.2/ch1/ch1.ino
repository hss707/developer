...
void test3()
{
  if ( delay1(100) == false ) return;
  Keyboard.print("3");
  if ( d_100() == false ) return;
  Keyboard.print("3");
  if ( d_110() == false ) return;
  Keyboard.print("3");
  if ( d_120() == false ) return;
  Keyboard.print("3");
  if ( d_110() == false ) return;
  Keyboard.print("3");
  if ( d_100() == false ) return;
  Keyboard.print("3");
  if ( d_50() == false ) return;
  Keyboard.print("3");
  if ( d_70() == false ) return;
  Keyboard.print("3");
  if ( d_90() == false ) return;
  Keyboard.print("3");
  if ( d_150() == false ) return;
  Keyboard.print("3");
  if ( d_140() == false ) return;
  Keyboard.print("3");
  if ( d_130() == false ) return;
  Keyboard.print("3");
  if ( d_150() == false ) return;
  Keyboard.print("3");
  if ( d_150() == false ) return;
